    ...
    public partial class DebugConsole : Form
    {
        ...
        public Image Rotate(Bitmap target, float angle)
        {
            ...
            using (Graphics gfx = Graphics.FromImage(result))
            {
                ...
                gfx.FillRegion(Brushes.White, new Region(new Rectangle(0, 0, width, height)));
        ...
        public void Main()
        {
            ...
            // espaço de sobra
            int dispWidth = pWidth - width * count;

            // centralizamos as cartas
            int betweenWidth = dispWidth / (count + 1);
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                phandle.DrawImage(Rotate(cards[i], a), (int)x, (int)y);
